        ...
        <div className="flex items-center justify-between px-4 py-3 sm:px-6">
            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-center">
                <nav className="isolate inline-flex -space-x-px rounded-md shadow-xs" aria-label="Pagination">
                    <a onClick={() => {setIndexSelected(indexSelected !== 1 ? indexSelected - 1 : indexSelected)}} className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
